...
| 1 | [Module 4 — Agent foundations and tool use](module-4-agent/README.md) | 4.1 · 4.2 · 4.3 |
| 2 | [Module 4, continued — the same agent on a real model](module-4-agent/README.md#lab-44--on-day-2-the-same-agent-on-a-real-model) | 4.4 |
