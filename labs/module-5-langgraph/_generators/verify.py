#!/usr/bin/env python3
"""Run every solution notebook's code cells and assert a clean score.
...
# Every name the notebooks resolve a model from, and OPENAI_API_BASE. Miss one and this "offline" verifier makes real model calls on the
